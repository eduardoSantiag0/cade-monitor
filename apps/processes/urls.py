...
urlpatterns = [
    ...
    path('<int:pk>/test-email/', views.process_send_test_email, name='test_email'),
    path('<int:pk>/test-whatsapp/', views.process_send_test_whatsapp, name='test_whatsapp'),
    path('<int:pk>/send-latest-update/', views.process_send_latest_update, name='send_latest_update'),
